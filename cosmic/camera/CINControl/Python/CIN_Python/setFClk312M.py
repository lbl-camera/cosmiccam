...
#def setFCLK250M():
print "**** Set CIN FCLK to 312.5MHz"
# Freeze DCO
...
print "  Set Si570 Oscillator Freq to 312.5MHz"
# WR Reg 7
cin_functions.WriteReg( cin_register_map.REG_FCLK_I2C_ADDRESS, "B007", 0)
cin_functions.WriteReg( cin_register_map.REG_FCLK_I2C_DATA_WR, "F001", 0)
cin_functions.WriteReg( cin_register_map.REG_FRM_COMMAND, cin_register_map.CMD_FCLK_COMMIT, 0)

# WR Reg 8
cin_functions.WriteReg( cin_register_map.REG_FCLK_I2C_ADDRESS, "B008", 0)
cin_functions.WriteReg( cin_register_map.REG_FCLK_I2C_DATA_WR, "F002", 0)
cin_functions.WriteReg( cin_register_map.REG_FRM_COMMAND, cin_register_map.CMD_FCLK_COMMIT, 0)
