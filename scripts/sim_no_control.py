...
class FccdSimulator:
    ...
    def create_exps(self):
        ...
        img = Image.fromarray((nb * 255).astype(np.uint8))
        img.save('original_simulation.png')  
    ...
    def run(self, num=1, triggers=20):
        ...
        for scan_num in range(num):
            ...
            print("Total dark frames: " + str(len(self.dark_frames)))
            print("Total exp frames: " + str(len(self.exp_frames)))
